...
object UiLayoutManager {
    ...
    private const val resourcePath = "playerlist/layout/ui_layout.json"
    ...
    private fun loadResource(): UiLayoutFile {
        ...
        if (stream == null) {
            PlayerListMod.logger.error("Missing bundled UI layout resource: {}", resourcePath)
        ...
        return stream.use { input ->
            runCatching {
                ...
                PlayerListMod.logger.error("Failed to load bundled UI layout resource: {}", resourcePath, it)
                defaultLayout
            }
        }
    }
