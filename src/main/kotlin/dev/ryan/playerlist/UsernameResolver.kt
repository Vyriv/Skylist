...
object UsernameResolver {
    ...
    fun resolve(username: String): CompletableFuture<ResolvedProfile?> {
        return CompletableFuture.supplyAsync({
            ...
            PlayerListMod.logger.warn("Failed to resolve username {}", username, it)
            null
        }
    }
    ...
    fun resolveUuid(uuid: String): CompletableFuture<String?> {
        return CompletableFuture.supplyAsync({
            ...
            PlayerListMod.logger.warn("Failed to resolve uuid {}: {}", uuid, it.rootCauseSummary())
            null
        }
    }
    ...
    fun resolveLinkedDiscord(uuid: String): CompletableFuture<LinkedDiscordLookup> {
        return CompletableFuture.supplyAsync({
            ...
            PlayerListMod.logger.warn("Failed to resolve linked Discord for uuid {}", uuid, it)
